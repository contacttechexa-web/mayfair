                ...
                <div class="col-md-6">
                    <div class="form-group-wrapper">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="text" class="form-control" id="inputTitle" name="title" placeholder="Enter Announcement Title" value="{{ old('title', $announcement->title) }}" maxlength="255" required>
                    </div>
                        @if ($errors->has('title'))
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group-wrapper">
                        ...
                        <textarea class="form-control" id="inputMessage" name="message" rows="4" placeholder="Enter Announcement Message" required style="padding-left: 16px;">{{ old('message', $announcement->message) }}</textarea>
